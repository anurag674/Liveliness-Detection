...
function finalizeVideo(){
    ...
    setMessage('Verifying You Please Wait ...<br>');
...
//console.log('the output is' + output);
  ...
  xhr.open('POST', 'savefiles.php?name='+name+'&chlng='+chlng, true);
  xhr.onload = function(e) {
    //console.log("loaded");
    setMessage('Finished');
    //setMessage(xhr.responseText);
    $("#chngtxt").html(xhr.responseText);
  ...
  xhr.send(output);
        setMessage('It will take a while ... We appreciate your patience');
        images = [];
